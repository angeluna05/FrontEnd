...
export class NavService implements OnDestroy {
  ...
  // Filtrar el menú basado en el rol guardado en localStorage
  private filterMenuByRole(): Menu[] {
    const role = localStorage.getItem('rolName');

    if (role === 'ADMIN') {
      return this.MENUITEMS_ADMIN;
    } else if (role === 'JOVEN') {

      return this.MENUITEMS_JOVEN;
    } else if (role === 'EMPLEADO') {

      return this.MENUITEMS_EMPLEADO;
    } else {
      return [];  // Si no hay un rol válido, devuelve un menú vacío o uno predeterminado
    }
  }

  // Obtener el menú filtrado
  getMenuItems(): BehaviorSubject<Menu[]> {
    const filteredMenu = this.filterMenuByRole();
    return new BehaviorSubject(filteredMenu);
  }
  ...
  //   {
  //   headTitle1: "Servicios",
  // },

  //     { path: "/celulas", title: "Células", icon: "learning", type: "link" },
  //     { path: "/empleados", title: "Facilitadores", icon: "ui-kits", type: "link" },
  //     { path: "/empresas", title: "Empresas", icon: "job-search", type: "link" },
  //     { path: "/encargados", title: "Encargados", icon: "social", type: "link" },
  //     { path: "/equipos", title: "Equipos", icon: "social", type: "link" },
  //     { path: "/instituciones", title: "Instituciones", icon: "others", type: "link" },
  //     { path: "/jovenes", title: "Jóvenes", icon: "user", type: "link" },
  //     { path: "/logros", title: "Logros", icon: "form", type: "link" },
  //     {
  ...
  //       active: false,
  //       children: [
  //         { path: "/programarsesiones", title: "Sesiones", type: "link" },
  //         { path: "/agenda", title: "Agenda", type: "link" },
  //       ],
  //     },
  //     { path: "/retos", title: "Retos", icon: "widget", type: "link" },
  //     { path: "/roles", title: "Roles", icon: "widget", type: "link" },
  //     { path: "/usuarios", title: "Usuarios", icon: "user", type: "link" },
  //     { path: "/celulas-jovenes", title: "Usuarios", icon: "user", type: "link" },
  //     { path: "/retos-jovenes", title: "Usuarios", icon: "user", type: "link" },
  // ];
  ...
  MENUITEMS_ADMIN: Menu[] = [
    { headTitle1: "General" },
    {
      title: "Configuración", icon: "widget", type: "sub", children: [
        { path: "/dashboard/default", title: "Dashboard", type: "link" },
        { path: "/roles", title: "Roles", icon: "widget", type: "link" }]
    },

    {
      title: "Usuarios", icon: "user", type: "sub", children: [
        { path: "/usuarios", title: "Usuarios", icon: "user", type: "link" },
        { path: "/jovenes", title: "Jóvenes", icon: "user", type: "link" },
        { path: "/empleados", title: "Facilitadores", icon: "ui-kits", type: "link" },
        { path: "/empresas", title: "Empresas", icon: "job-search", type: "link" },
    ...
    {
      title: "Servicios", icon: "learning", type: "sub", children: [
        { path: "/retos", title: "Retos", icon: "widget", type: "link" },
        { path: "/celulas", title: "Células", icon: "learning", type: "link" },
        { path: "/equipos", title: "Equipos", icon: "social", type: "link" },
        { path: "/instituciones", title: "Instituciones", icon: "others", type: "link" },
    ...
    },
    {
      ...
      active: false,
      children: [
        { path: "/programarsesiones", title: "Sesiones", icon: "calendar", type: "link" },
      ],
    },
  ];

  MENUITEMS_JOVEN: Menu[] = [
    { headTitle1: "General" },
    { title: "Tablero", icon: "home", type: "sub", children: [{ path: "/index", title: "Index", type: "link" }] },

    {
      title: "Servicios", icon: "home", type: "sub", children: [
      { path: "/retos-jovenes", title: "Retos", icon: "widget", type: "link" },
      { path: "/celulas-jovenes", title: "Células", icon: "learning", type: "link" },
      ]
    }, {
      title: "Calendario",
      icon: "calender",
      ...
      active: false,
      children: [
        { path: "/sesiones", title: "Sesiones", icon: "to-do", type: "link" },
      ],
    },
  ];

  MENUITEMS_EMPLEADO: Menu[] = [
    { headTitle1: "General" },
    {
      title: "Servicios", icon: "home", type: "sub", children: [
      { path: "/retos-facilitador", title: "Retos", icon: "widget", type: "link" },
      { path: "/celulas-facilitador", title: "Células", icon: "learning", type: "link" },
      ]
    }, { title: "Calendario", icon: "calender", type: "sub", children: [{ path: "/asistencia", title: "Sesiones", type: "link" }] },
  ];

  items = new BehaviorSubject<Menu[]>(this.filterMenuByRole());
